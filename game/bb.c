...
int move_pacman1(int pr,int pc)
{
	...
	pdown_col=pc;
		...
		if(map_state[pright_row][pright_col]!='W'&&(map_state[pright_row][pright_col]!='A'||map_state[pright_row][pright_col]!='B'||map_state[pright_row][pright_col]!='C'||map_state[pright_row][pright_col]!='D'))
		return 4;

	else if(map_state[pleft_row][pleft_col]!='W'&&(map_state[pleft_row][pleft_col]!='A'||map_state[pleft_row][pleft_col]!='B'||map_state[pleft_row][pleft_col]!='C'||map_state[pleft_row][pleft_col]!='D'))
		return 3;
...
//	int ghost_row, ghost_col;
	...
	if(map_state[gup_row][gup_col]!='W'&&(map_state[gup_row][gup_col]!='A'||map_state[gup_row][gup_col]!='B'||map_state[gup_row][gup_col]!='C'||map_state[gup_row][gup_col]!='D'))
		return 1;
